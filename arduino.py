...
tkTop = tkinter.Tk()
tkTop.geometry('1200x900')
tkTop.title("PLC FishTank")
label3 = tkinter.Label(text = 'Building Python GUI to interface an arduino,and control 200L Fish Tank',
                       font=("CourierNew", 12,'bold')).pack()
tkTop.counter = 0
b = tkTop.counter
